...
export function ForayIcon({
  ...
  switch (name) {
    ...
    case "link":
      return (
        <svg {...common}>
          <path d="M10 13a5 5 0 0 0 7.54.54l1.4-1.4a5 5 0 0 0-7.07-7.07l-.8.8" />
          <path d="M14 11a5 5 0 0 0-7.54-.54l-1.4 1.4a5 5 0 0 0 7.07 7.07l.8-.8" />
        </svg>
      );
    case "banknote":
      return (
        <svg {...common}>
          ...
          <path d="M12 9.2v5.6" />
          <path d="M10.2 10.4c.4-.7 1-.9 1.8-.9.9 0 1.6.4 1.6 1.2 0 1.6-3.4 1-3.4 2.8 0 .8.7 1.3 1.8 1.3.8 0 1.4-.3 1.8-.8" />
        </svg>
      );
    case "forkKnife":
      return (
